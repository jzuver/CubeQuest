...
bool Quad::isOverlapping(const Quad &q) const {
    ...
    if(this->getLeftX() < q.getRightX() && this->getLeftX() > q.getLeftX() && ((this->getTopY() > q.getTopY() && this->getTopY() < q.getBottomY()) || (this->getBottomY() < q.getBottomY() && this->getBottomY() > q.getTopY()))){
        return true;
    }
